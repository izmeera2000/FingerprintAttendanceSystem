$(function () {
  ...
  $(".preloader").fadeOut(),
    ...
    $(".sidebartoggler").on("click", function () {
      // Set or remove localStorage item based on the current state
      toggleSidebarSwitch();
  ...
  // Function to toggle the mdi-toggle-switch-off class
  function toggleSidebarSwitch() {
    if ($("#main-wrapper").attr("data-sidebartype") === "mini-sidebar") {
      $(".mdi-toggle-switch").addClass("mdi-toggle-switch-off");
    } else {
      $(".mdi-toggle-switch").removeClass("mdi-toggle-switch-off");
    }
  }
  toggleSidebarSwitch();
