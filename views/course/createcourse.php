...
<body>
              ...
              <div class="card-body">
                ...
                <div class="d-flex flex-row-reverse p-2 ">
                  <button type="button" class="btn waves-effect waves-light btn-rounded btn-primary "
                    id="buttoncreatecourse">Create Device</button>
                  <!-- <button type="button"
                ...
                <div class="row">
                  ...
                  <div class="table-responsive">
                    <table id="course_create" class="table table-striped table-bordered text-nowrap">
                      <thead>
                        <!-- start row -->
                        <tr>
                          <th>Nama</th>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      var dt1 = $('#course_create').DataTable({
        ...
        columns: [
          ...
          { data: "b", responsivePriority: 1 },
          {
            ...
            render: function (data, type, row, meta) {
              return '<button type="button" class="btn btn-primary edit-course" data-id="' + row.id + '">Show Details</button>';
            }
          },
        ],
        processing: true,
      ...
      document.getElementById('buttoncreatecourse').onclick = function () {
      ...
      $('#course_create').on('click', '.edit-course', function () {
