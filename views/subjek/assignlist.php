...
<body>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="table-responsive">
                    <table id="subjek_assignlist" class="table   table-bordered text-nowrap">
                      <thead>
                        <!-- start row -->
                        <tr>
                          <th>Subjek</th>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      var dt1 = $('#subjek_assignlist').DataTable({
        ...
        columns: [
          ...
          { data: "e", responsivePriority: 1 },
          {
            data: "id",
            className: "text-center",
            responsivePriority: 1,
            render: function (data, type, row, meta) {
              return '<button type="button" class="btn btn-danger delete-assign-subjek m-2" data-id="' + row.id + '">Delete</button>';
            }
          },
        ],
        processing: true,
    ...
    //   });
      ...
      $('#subjek_assignlist').on('click', '.delete-assign-subjek', function () {
        var id = $(this).data('id');  // Get the ID from the button's data attribute
        $.ajax({
          type: "POST",
          url: "deleteassignslot",
          data: {
            deleteassignslot: {
              id: id,
