                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="d-flex no-block align-items-center">
                      <div>
                        <i
                          class="ri-money-euro-circle-line fs-6 text-muted"
                        ></i>
            ...
            <div class="col-lg-3 col-md-6 order-lg-3 order-md-2">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h2 class="fw-light">
                    35,658
                    <span class="fs-4 text-success font-weight-medium"
                      >+23%</span
                    >
                  </h2>
                  <div class="mt-4 pt-3">
                ...
                >
                  ...
                  <div class="d-flex flex-row comment-row p-3">
                    <div class="p-2">
                      <span
                        ><img
                          src=" <?php  echo $site_url ?>assets/images/users/1.jpg"
                  ...
                  <div class="d-flex flex-row comment-row active p-3">
                    <div class="p-2">
                      <span
                        ...
                        "
                        ><img
                          src=" <?php  echo $site_url ?>assets/images/users/2.jpg"
                          class="rounded-circle"
                          alt="user"
                          width="50"
                      /></span>
                  ...
                  <div class="d-flex flex-row comment-row p-3">
                    <div class="p-2">
                      <span
                        ...
                        "
                        ><img
                          src=" <?php  echo $site_url ?>assets/images/users/3.jpg"
                          class="rounded-circle"
                          alt="user"
                          width="50"
                      /></span>
                  ...
                  <div class="d-flex flex-row comment-row p-3">
                    <div class="p-2">
                      <span class=""
                        ><img
                          src=" <?php  echo $site_url ?>assets/images/users/4.jpg"
                          class="rounded-circle"
                          alt="user"
                          width="50"
                      /></span>
